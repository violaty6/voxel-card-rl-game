                            ...
                            if (_selectedCustomChain > -1)
                            {
                                ...
                                if (_chainModeDraw == EBonesChainDrawMode.BonesSetup)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        chain.AxisLimitRange = EditorGUILayout.Slider(new GUIContent("Joints Rotation Limit Range:", "Limiting joints rotation angle for all bones in chain: 1 = 90 degrees : 0.01 = 1 degrees."), chain.ChainScaleMultiplier, 0.01f, 1f);
                                        EditorGUIUtility.labelWidth = 0;
            ...
            if (_selectedBoneSetup != null)
            {
                ...
                if (_selectedBoneSetup != null)
                {
                    ...
                    if (_customChain_limitsFoldout)
                    {
                        ...
                        {
                            if (Application.isPlaying) _selectedBoneSetup.ApplyJointLimitsPlaymode();
                        }
